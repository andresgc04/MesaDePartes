                    ...
                    <div class="hero-static col-md-6 col-xl-8 d-none d-md-flex align-items-md-end">
                        <div class="p-30 invisible" data-toggle="appear">
                            <p class="font-size-h3 font-w600 text-white mb-5">
                                Andres Guerrero Cordero
                            </p>
                            <p class="font-size-h5 text-white">
                                <i class="fa fa-angles-right"></i> www.andresGc.dev
                            </p>
                    ...
                    <div class="hero-static col-md-6 col-xl-4 d-flex align-items-center bg-white">
                        <div class="content content-full">
                            ...
                            <div class="px-30 py-10">
                                ...
                                <h2 class="h5 font-w400 text-muted mb-0">Porfavor agregue los detalles requeridos</h2>
                            </div>
                            <!-- END Header -->
                                ...
                                <div class="form-group row">
                                    <div class="col-12">
                                        <div class="form-material floating">
                                            ...
                                            <label for="signup-username">Nombres y Apellidos</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
